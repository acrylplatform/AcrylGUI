(function () {
     ...
     * @return {TransactionInfoShop}
     */
    const controller = function (BaseTxInfo, $scope, balanceWatcher) {

        class TransactionInfoShop extends BaseTxInfo {
        ...
        return new TransactionInfoShop();
    };

    controller.$inject = ['BaseTxInfo', '$scope', 'balanceWatcher'];

    angular.module('app.ui').component('wTransactionInfoShop', {
        bindings: {
            signable: '<',
            isConfirm: '<'
        },
        templateUrl: 'modules/ui/directives/transactionInfo/transaction-info-shop.html',
        controller
    });
})();
