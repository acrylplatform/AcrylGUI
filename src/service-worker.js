...
console.log('????isFileCached :', isFileCached);
    if (isFileCached) {
      event.respondWith(
        caches.open($CACHE_STORE)
          .then(cache => {
